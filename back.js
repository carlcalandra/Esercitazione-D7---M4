...
const createProductsTable = () => {
    ...
    thead.innerHTML = `<th scope="col">Name</th><th scope="col">Description</th>
                        <th scope="col">Brand</th><th scope="col">Image</th>
                        <th scope="col">Price</th><th scope="col">Actions</th>`
...
const handleClickModal = () => {
    const title = !editProduct ? "Add a new product" : `Edit item ${editProduct._id}`
...
const addTableSection = () => {
    if (products.length === 0) {
        tableDiv.innerHTML = `<h3 class="text-center">You do not have products at the moment</h3>`
    } else {
        tableDiv.innerHTML = "";
